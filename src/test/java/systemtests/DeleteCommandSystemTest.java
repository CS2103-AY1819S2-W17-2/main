...
import static seedu.address.logic.commands.PatientDeleteCommand.MESSAGE_DELETE_PERSON_SUCCESS;
...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    private static final String MESSAGE_INVALID_DELETE_COMMAND_FORMAT =
            String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, PatientDeleteCommand.MESSAGE_USAGE);
    ...
    public void delete() {
        ...
        String command = "     " + PatientDeleteCommand.COMMAND_WORD + "      " + INDEX_FIRST_PERSON.getOneBased()
            + "       ";
        ...
        command = PatientDeleteCommand.COMMAND_WORD + " " + invalidIndex;
        ...
        command = PatientDeleteCommand.COMMAND_WORD + " " + selectedIndex.getOneBased();
        ...
        command = PatientDeleteCommand.COMMAND_WORD + " 0";
        assertCommandFailure(command, MESSAGE_INVALID_DELETE_COMMAND_FORMAT);

        /* Case: invalid index (-1) -> rejected */
        command = PatientDeleteCommand.COMMAND_WORD + " -1";
        assertCommandFailure(command, MESSAGE_INVALID_DELETE_COMMAND_FORMAT);

        /* Case: invalid index (size + 1) -> rejected */
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getAddressBook().getPersonList().size() + 1);
        command = PatientDeleteCommand.COMMAND_WORD + " " + outOfBoundsIndex.getOneBased();
        assertCommandFailure(command, MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);

        /* Case: invalid arguments (alphabets) -> rejected */
        assertCommandFailure(PatientDeleteCommand.COMMAND_WORD + " abc", MESSAGE_INVALID_DELETE_COMMAND_FORMAT);

        /* Case: invalid arguments (extra argument) -> rejected */
        assertCommandFailure(PatientDeleteCommand.COMMAND_WORD + " 1 abc", MESSAGE_INVALID_DELETE_COMMAND_FORMAT);
